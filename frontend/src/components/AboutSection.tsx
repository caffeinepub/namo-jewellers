      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <img
              src="/assets/generated/about-illustration.dim_800x600.png"
              alt="Namo Jewellers Collection"
              className="w-full h-auto object-cover relative z-10"
            />
            {/* Rating Badge Overlay */}
            <div className="absolute -bottom-6 -right-6 z-20 bg-charcoal px-6 py-4 border border-gold/40 shadow-gold-md">
              <div className="flex gap-1 mb-1">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} size={14} className="fill-gold text-gold" />
                ))}
              </div>
              <p className="font-display text-2xl text-gold font-bold leading-none">4.7</p>
              <p className="font-body text-xs text-champagne/60 tracking-widest uppercase mt-1">Star Rating</p>
            </div>
          </div>
          ...
          <div className="lg:pl-8">
            <p className="font-display text-2xl md:text-3xl text-charcoal italic leading-relaxed mb-6">
              "Every woman deserves to shine with elegance and confidence."
            </p>
            <div className="w-16 h-px bg-gold mb-8" />
            <p className="font-body text-base text-charcoal/70 leading-relaxed mb-6">
              Welcome to <strong className="text-charcoal font-semibold">Namo Jewellers</strong>, your trusted destination for high fashion One Gram Gold Jewellery. We believe in making luxury accessible to every woman.
            </p>
            <p className="font-body text-base text-charcoal/70 leading-relaxed mb-8">
              Our collection combines traditional beauty with modern trends, giving you jewellery that looks premium yet remains affordable. With a 4.7-star customer rating, we are proud to be known for quality, trust, and customer satisfaction.
            </p>
