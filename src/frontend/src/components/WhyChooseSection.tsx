...
const reasons = [
  { title: 'High Fashion Designs', desc: 'Curated silver styles that reflect the latest jewellery trends.' },
  { title: 'Pure Sterling Silver', desc: 'Genuine silver pieces that retain their lustrous shine beautifully.' },
