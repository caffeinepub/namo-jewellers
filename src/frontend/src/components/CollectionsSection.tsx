...
const collections: Collection[] = [
  {
    emoji: '👑',
    name: 'Silver Bridal Collection',
    description: 'Stunning sterling silver bridal sets crafted to make your special day unforgettable.',
    image: '/assets/generated/collection-silver-bridal.dim_600x400.png',
  },
  {
    emoji: '💎',
    name: 'Silver Necklaces',
    description: 'Elegant oxidised and polished silver necklace designs for every occasion.',
    image: '/assets/generated/collection-silver-necklaces.dim_600x400.png',
  },
  {
    emoji: '✨',
    name: 'Silver Earrings',
    description: 'From delicate daily wear studs to grand festive jhumkas and chandbalis.',
    image: '/assets/generated/collection-silver-earrings.dim_600x400.png',
  },
  {
    emoji: '💫',
    name: 'Bangles & Bracelets',
    description: 'Handcrafted silver bangles and bracelets for traditional and modern looks.',
    image: '/assets/generated/collection-silver-bangles.dim_600x400.png',
  },
  {
    emoji: '🌸',
    name: 'Daily Wear Silver',
    description: 'Lightweight, fashionable silver designs perfect for everyday elegance.',
    image: '/assets/generated/collection-silver-dailywear.dim_600x400.png',
  },
];
    ...
    <section id="collections" className="py-24 lg:py-32 bg-charcoal">
      ...
      <div className="text-center mb-16 px-6">
        ...
        <p className="font-body text-moonstone/50 text-sm tracking-widest uppercase mt-6 max-w-md mx-auto">
          Discover our exclusive range of high fashion sterling silver jewellery
        </p>
      </div>
