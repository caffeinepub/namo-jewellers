      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="font-body text-sm text-moonstone/50 leading-relaxed mb-6">
              Your trusted destination for high fashion Sterling Silver Jewellery. Handcrafted designs, timeless elegance.
            </p>
              ...
              {navLinks.map((link) => (
                <li key={link.href}>
                  <button
                    ...
                    className="font-body text-sm text-moonstone/50 hover:text-silver transition-colors duration-300 tracking-wide"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <Clock size={14} className="text-silver mt-0.5 shrink-0" />
                <div>
              ...
              <li className="flex items-start gap-3">
                <Phone size={14} className="text-silver mt-0.5 shrink-0" />
                <div>
                  <p className="font-body text-xs text-moonstone/40 tracking-widest uppercase mb-0.5">Phone</p>
                  <a href="tel:+919177066512" className="font-body text-sm text-moonstone/60 hover:text-silver transition-colors">
                    +91 91770 66512
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <MapPin size={14} className="text-silver mt-0.5 shrink-0" />
                <div>
                  <p className="font-body text-xs text-moonstone/40 tracking-widest uppercase mb-0.5">Location</p>
                  <a
                    ...
                    className="font-body text-sm text-moonstone/60 hover:text-silver transition-colors"
                  >
                    Shop No. 1300, Mahaveer Arcade, Pioneer Bazar, Bolarum, Secunderabad – 500010
                  </a>
                </div>
              </li>
            </ul>
